...
//get all products based on filters (by arrival  and by sold )
/*
  by sell = /products?sortBy=sold&order=desc&limit=4
  by arrival = /products?sortBy=createdAt&order=desc&limit=4

  if no params send then /products will work and get all the products with no filters 
*/
...
/**
 * it will find the product based on req product categorie
